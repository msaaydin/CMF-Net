...
def read_excel_data(path):
    ...
    data = data[['HASTA ADI', 'CİNSİYET', 'YAŞ', 'kreatinin', 'NT proBNP', 'TROPONIN I',
        'eko EF', 'eko bulguları',
       'Split']]
    ...
    for _, row in data.iterrows():
        ...
        record[-3:] = [row['kreatinin'], row['NT proBNP'] if row['NT proBNP'] != 'yok' else 0, row['eko EF']]
